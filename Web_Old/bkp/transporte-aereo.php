...
<head>
<meta charset="utf-8">
<title>I9 Express - Serviços - I9 Transporte Aéreo de Cargas</title>
		...
		<article class="container-esquerda">
			...
			<div class="encapsula-servicos">
				...
				<div class="bloco-servicos-txt">
					<img src="img/icon-aviao.png" align="left" style="margin-right: 10px;">
					<h1 class="titulo-bloco-quem">I9 Transporte Aéreo de Cargas</h1>
					<p class="txt-quem-somos">O serviço “I9 Transporte Aéreo de Cargas” atende a todo o Brasil e garante a coleta e entrega da carga ou encomenda em até 72 horas. Dependendo da urgência e necessidade até no mesmo dia. </p>
					<p class="txt-quem-somos">Temos grande malha, ligada a várias companhias aéreas que nos garante agilidade e flexibilidade para atender os nossos clientes. </p>
