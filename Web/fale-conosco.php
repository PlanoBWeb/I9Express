...
<head>
	...
	<![endif]-->
	<title>Fale conosco para solicitar motoboy, entregas, transporte de cargas.</title>
			...
			<div class="col-xs-12 col-sm-8 col-md-8 pd-none">
				...
				<article class="bloco-servicos">
					<div class="bloco-titulo-servico">
						...
						<h2 class="titulo-servico">FALE CONOSCO:</h2>
					</div>
					<div class="bloco-encapsula-servicos">
						<h1 class="txt-quem-somos">Para enviar sua dúvida, crítica ou sugestões, preencha o formulário abaixo retornaremos o mais breve possível.</h1>
