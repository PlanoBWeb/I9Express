		...
		<section class="conteudo conteudo-interna">
			<div class="col-xs-12 col-sm-8 col-md-8 pd-none">
				...
				<article class="bloco-servicos">
					...
					<p class="txt-quem-somos">• Disponibilização de sistema a todos os seus clientes cadastrados com LOGIN e SENHA exclusivo para efetuar solicitações de serviços, acompanhamento diário através do relatório on-line e faturamento.  </p>
					<p class="txt-quem-somos">• Setores informatizados através de software para controle da frota, sejam eles na necessidade de localização do portador ou na conferência de O.S, faturas e demonstrativos.</p>
					</div>
				</article>
			</div>
			<!-- Bloco Menu Lateral -->
